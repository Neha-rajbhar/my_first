...
function Second() {
    ...
    let [arr, setArr] = useState(JSON.parse(localStorage.getItem("userData")) || []);
                                ...
                                return (
                                    <>
                                        <tr key={index}>
                                            ...
                                            <td className={style.td}><button className={style.delete} onClick={() => handleDelete(users.firstName)}>delete</button> </td>
